# ENDPOINTS: Gestor de Turnos

[Volver a Inicio](../../README.md)

> Las Rutas de nuestro Backend deben responder según las siguientes indicaciones:

# Users

## GET /user/:id
- **Descripción:**
	- Obtiene un usuario por su id junto con sus turnos.
- **Parámetros:**
	- id: id del usuario.
- **Respuesta:**
